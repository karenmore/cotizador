...
function App() {
  ...
  useEffect(() => {
    const result = calcularTotalPagar(cantidad, meses)
    setTotal(result)
  ...
  function handleClickDecrementando() {
  ...
  function handleClickIncremento() {
    ...
    if(valor > MAX){
      alert('Esta es la cantidad Maxima permitida')
      return;
    }
  ...
  return (
    <div className="my-20 max-w-lg mx-auto bg-white shadow p-10">
      <Header/> {/* Esto esta en un compoente y lo importamos */} 

      <div className='flex justify-between my-6'>
        <Button 
          operador='-'
          fn={handleClickDecrementando}
        />
        <Button
          operador='+'
